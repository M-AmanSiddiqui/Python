...
#  Pehla letter capital karta hai, baaki lowercase
# Output: "Hello world"

# 2. casefold()
str2 = "HELLO WORLD"
print("2. str2.casefold():", str2.casefold())
#  String ko aggressive lowercase me convert karta hai
# Output: "hello world"

# 3. center(width, fillchar)
str3 = "Hello"
print("3. str3.center(10,'*'):", str3.center(10,'*'))
#  String ko center karta hai aur extra space fillchar se fill karta hai
# Output: "**Hello***"

# 4. count(substring)
str4 = "hello hello world"
print("4. str4.count('hello'):", str4.count("hello"))
#  Substring kitni baar hai count karta hai
# Output: 2
...
#  Last occurrence ka index return karta hai, nahi mile to error
# Output: 12

# 32. rjust(width, fillchar)
str32 = "Hello"
print("32. str32.rjust(10,'*'):", str32.rjust(10,'*'))
#  String right justify karta hai aur extra space fillchar se fill
# Output: "*****Hello"

# 33. rpartition(sep)
str33 = "Siddiqui is great"
print("33. str33.rpartition('is'):", str33.rpartition("is"))
#  Separator ke basis pe last occurrence ka 3-tuple return karta hai
# Output: ('Siddiqui ', 'is', ' great')

# 34. rsplit(sep)
str34 = "a,b,c,d"
print("34. str34.rsplit(',',2):", str34.rsplit(",",2))
#  Right side se split karta hai aur list return karta hai
# Output: ['a','b','c','d']

# 35. rstrip(chars)
str35 = "Hello***"
print("35. str35.rstrip('*'):", str35.rstrip('*'))
#  Right side ke specified characters remove karta hai
# Output: "Hello"

# 36. split(sep)
str36 = "a,b,c,d"
print("36. str36.split(','):", str36.split(','))
#  Separator ke basis pe split karke list return karta hai
# Output: ['a','b','c','d']

# 37. splitlines(keepends)
str37 = "Hello\nWorld"
print("37. str37.splitlines():", str37.splitlines())
#  Newline pe split karke list return karta hai
# Output: ['Hello','World']

# 38. startswith(prefix)
str38 = "Hello World"
print("38. str38.startswith('Hello'):", str38.startswith("Hello"))
#  Check karta hai string prefix se start hoti hai ya nahi
# Output: True

# 39. strip(chars)
str39 = "***Hello***"
print("39. str39.strip('*'):", str39.strip('*'))
#  Left aur right dono side ke specified characters remove
# Output: "Hello"

# 40. swapcase()
str40 = "Hello World"
print("40. str40.swapcase():", str40.swapcase())
#  Uppercase to lowercase aur lowercase to uppercase karta hai
# Output: "hELLO wORLD"

# 41. title()
str41 = "hello world"
print("41. str41.title():", str41.title())
#  Har word ka first letter uppercase karta hai
# Output: "Hello World"
...
#  Characters ko translate karta hai mapping table ke according
# Output: "hello world"
...
#  String ko zero se left pad karta hai
# Output: "00042"

# 45. isdecimal()
str45 = "123"
print("45. str45.isdecimal():", str45.isdecimal())
#  Check karta hai ki string decimal characters se bani hai
# Output: True

# 46. isdigit()
str46 = "123"
print("46. str46.isdigit():", str46.isdigit())
#  Check karta hai ki string digits se bani hai
# Output: True
...
#  Sirf whitespaces check karta hai
# Output: True
